...
if ( ! class_exists( 'Tortuga_Pro_Admin_Notices' ) ) :
...
class Tortuga_Pro_Admin_Notices {
	...
	*/
	...
	static function activate_license() { 
		...
		if( '' == $options->get( 'license_key' ) && in_array( $pagenow, array( 'index.php', 'update-core.php', 'plugins.php' ) ) && current_theme_supports( 'tortuga-pro' ) && ! get_transient( 'tortuga_pro_activate_license_dismissed' ) && current_user_can( 'edit_theme_options' ) ) : ?>
	...
	static function expired_license() { 
		...
		if( 'expired' == $options->get( 'license_status' ) && in_array( $pagenow, array( 'index.php', 'update-core.php', 'plugins.php' ) ) && current_theme_supports( 'tortuga-pro' ) && ! get_transient( 'tortuga_pro_expired_license_dismissed' ) && current_user_can( 'edit_theme_options' ) ) : ?>
	...
	static function missing_theme() { 
		...
		if( ! current_theme_supports( 'tortuga-pro' ) && in_array( $pagenow, array( 'index.php', 'update-core.php', 'plugins.php' ) ) && ! get_transient( 'tortuga_pro_missing_theme_dismissed' ) && current_user_can( 'edit_theme_options' ) ) : ?>
			...
			<div class="notice notice-warning">
				<p>
					...
					<a style="float: right" href="<?php echo wp_nonce_url( add_query_arg( array( 'tortuga_pro_action' => 'dismiss_notices', 'tortuga_pro_notice' => 'missing_theme' ) ), 'tortuga_pro_dismiss_notice', 'tortuga_pro_dismiss_notice_nonce' ); ?>"><?php _e( 'Dismiss Notice', 'tortuga-pro' ); ?></a>
				</p>
